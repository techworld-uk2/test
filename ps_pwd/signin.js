...
var init = function() {
  ...
  if (window.navigator.standalone) {
    setCookie("IOS_FULLSCREEN", "1", null, "https://hrmsunionparivar.unionbankofindia.co.in/");
  } else {
    setCookie("IOS_FULLSCREEN", "0", null, "https://hrmsunionparivar.unionbankofindia.co.in/");
  }
},
...
getFFVersion = function(){   
  ...
  try {
    var idxUA = navigator.userAgent.lastIndexOf("Firefox/index.html");
    if (idxUA == -1) 
        return -1;
...
function updatePTCookie(jsonString, cookieName) {
    ...
    setCookie(cookieName, sCookieValue, 1000, "https://hrmsunionparivar.unionbankofindia.co.in/", sDomain, secure);
}
...
function ptMAFContainer(){
    ...
    if (isDevice == 1){
        try {
            ...
            http.open('HEAD.html', "../../_maf.device_/www/js/base.html", false);
            http.send();
